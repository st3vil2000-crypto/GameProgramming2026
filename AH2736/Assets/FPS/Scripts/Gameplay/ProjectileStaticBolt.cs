...
namespace AH2736
{
    public class ProjectileStaticBolt : ProjectileBase
    {
        ...
        // ++ Added: Charge Variables
        [Header("Charge")]
        [Tooltip("Change in charge caused by the projectile")]
        public int DeltaCharge = 1; // absolute integer value of charge
        public bool ChargePositive = true;  // is the charge positive? else negative
        ...
        void OnHit(Vector3 point, Vector3 normal, Collider collider)
        {
            ...
            // ++ Added: Charge effects
                ...
                //todo implement area charge damage

            // point charge
            Chargeable chargeable = collider.GetComponent<Chargeable>();
            if (chargeable)
            {
                chargeable.InflictCharge(DeltaCharge, ChargePositive, m_ProjectileBase.Owner);
            }
